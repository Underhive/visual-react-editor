...
export function ColorPicker(pallete, selectorEngine: any) {
  ...
  const extractColors = (elements: HTMLElement[]) => {
...
export const healthyContrastColor = (color: TinyColor) => {
...
export const functionalNotate = (color: string) => {
