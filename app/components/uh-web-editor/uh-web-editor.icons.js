...
export const tearDrop = `<svg class="svg" xmlns="http://www.w3.org/2000/svg" width="8" height="10" viewBox="0 0 8 10"><path fill="#000" fill-opacity="1" fill-rule="evenodd" stroke="none" d="M4 0 1.17 2.925C.39 3.733 0 4.81 0 5.845c0 1.036.39 2.129 1.17 2.936.78.808 1.805 1.217 2.83 1.217 1.025 0 2.05-.409 2.83-1.217C7.61 7.974 8 6.881 8 5.846c0-1.036-.39-2.113-1.17-2.92L4 0zm0 1.438L6.11 3.62c.59.61.89 1.432.89 2.226 0 .797-.304 1.634-.89 2.24-.589.61-1.353.912-2.11.912-.757 0-1.521-.301-2.11-.911C1.303 7.48 1 6.643 1 5.846c0-.794.301-1.617.89-2.226-.001 0 0 0 0 0L4 1.438z"></path></svg>`

export const dropdownArrow = `<svg class="svg" xmlns="http://www.w3.org/2000/svg" width="8" height="7" viewBox="0 0 8 7"><path fill="#000" fill-opacity="1" fill-rule="evenodd" stroke="none" d="m3.646 5.354-3-3 .708-.708L4 4.293l2.646-2.647.708.708-3 3L4 5.707l-.354-.353z"></path></svg>`
