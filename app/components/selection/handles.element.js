...
export class Handles extends HTMLElement {
  ...
  set backdrop(bd) {
    ...
    const cur_child = this.$shadow.querySelector('uhWebEditor-boxmodel')
  ...
  render({ x, y, width, height, top, left }, node_label_id, isFixed) {
    ...
    return `
      ...
      <uhWebEditor-handle placement="top-start"></uhWebEditor-handle>
      <uhWebEditor-handle placement="top-center"></uhWebEditor-handle>
      <uhWebEditor-handle placement="top-end"></uhWebEditor-handle>
      <uhWebEditor-handle placement="middle-start"></uhWebEditor-handle>
      <uhWebEditor-handle placement="middle-end"></uhWebEditor-handle>
      <uhWebEditor-handle placement="bottom-start"></uhWebEditor-handle>
      <uhWebEditor-handle placement="bottom-center"></uhWebEditor-handle>
      <uhWebEditor-handle placement="bottom-end"></uhWebEditor-handle>
    `
  }
}

customElements.define('uhWebEditor-handles', Handles)
